...
export class SceneManager {
  ...
  constructor(container: HTMLDivElement, onSelect: SelectCallback) {
    ...
    const gridHelper = new THREE.GridHelper(20, 20, 0x444455, 0x2a2a36)
